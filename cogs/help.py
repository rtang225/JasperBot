...
#Help Command
    ...
    #Table of Contents
        tableOfContents = discord.Embed(title = 'LCSS Help Page', description = 'Main Menu:', color = BotConfig.color())
    ...
    #Dev Page
        dev = discord.Embed(title = 'LCSS Help Page', description = '🛠️ Dev Commands:', color = BotConfig.color())
    ...
    #Moderation Page
        moderation = discord.Embed(title = 'LCSS Help Page', description = '🛡️ Moderation Commands:', color = BotConfig.color())
        ...
        moderation.add_field(name = '!removewarn @User (Warn #)', value = 'Removes a specific warn from a user', inline = False)
    ...
    #Info Page
        info = discord.Embed(title = 'LCSS Help Page', description = '❓ Info Commands:', color = BotConfig.color())
    ...
    #Utilities Page
        utilities = discord.Embed(title = 'LCSS Help Page', description = '📊 Utilities Commands:', color = BotConfig.color())
        ...
        utilities.add_field(name = '!pollresults (Poll ID)', value = 'View results of a poll!', inline = False)
        utilities.add_field(name = '!reactionrole (Channel) (Role)', value = 'Allows users to get a role from reacting', inline = False)
    ...
    #Fun Page
        fun = discord.Embed(title = 'LCSS Help Page', description = '🎲 Fun Commands:', color = BotConfig.color())
        ...
        fun.add_field(name = '!highfive @User [Aliases = !high5, !h5, !hf]', value = 'Gives your friend a high five', inline = False)
    ...
    #Test Page
        test = discord.Embed(title = 'LCSS Help Page', description = '🚧 Test Commands:', color = BotConfig.color())
